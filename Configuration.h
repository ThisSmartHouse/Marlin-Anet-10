...
#define STRING_CONFIG_H_AUTHOR "John Coggeshall <john@thissmarthouse.com>" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "This Smart House" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "  http://www.thissmarthouse.net/  "         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "3D Printer 1"
